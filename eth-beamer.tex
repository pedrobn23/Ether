...
%% Título y otros %%
\title{Ethereum}                                               % Título
\subtitle{Un sistema de contratos inteligentes}                                  % Subtítulo
\author[Pedro y Ana]{ %
Ana Peña Arnedo\\
Pedro Bonilla Nadal} % Autor y e-mail
\date{3º Doble Grado informática y matemáticas}                                                            % Fecha
